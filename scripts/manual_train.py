...
sys.path.append('/home/vinit/retinanet_train/keras-retinanet/')
...
def create_callbacks(
    ...
    def scheduler(epoch):
        if epoch == 1:
            ...
            return args.lr * math.pow(0.95, (epoch - 3))
    ...
    # save the model
    if args.snapshots:
        # ensure directory created first; otherwise h5py will error after
        # epoch.
...
def create_eval_generator(args):
    """ Create generators for evaluation.
    """

    if args.dataset_type == 'csv':
        validation_generator = CSVGenerator(
            args.eval_annotations,
            args.eval_classes,
            image_min_side=args.image_min_side,
            image_max_side=args.image_max_side
        )
        ...
        raise ValueError(
            'Invalid data type received: {}'.format(
                args.dataset_type))
...
class Object(object):
    pass
num_imgs = len([i for i in glob.glob(
    '/home/vinit/data/human_seat_data_JAN2020_cleaned/TRAINING/**/images/*.jpg')])

args = Object()
# args.random_transform = True
args.snapshot = None
args.imagenet_weights = True
args.weights = '/home/vinit/retinanet_train/keras-retinanet/resnet50_csv_03.h5'
args.no_weights = False
args.backbone = 'resnet50'
args.batch_size = 4
args.gpu = "0"
args.multi_gpu_force = None
args.epochs = 48
args.snapshot_path = '/home/vinit/retinanet_train/keras-retinanet/snapshots/'
args.val_annotations = '/home/vinit/data/human_seat_data_JAN2020_cleaned/out/val_annotations.csv'
args.multi_gpu = 1
args.steps = int(num_imgs * 1.0 / args.batch_size)
args.tensorboard_dir = '/data/logs'
args.snapshots = True
args.evaluation = True
args.freeze_backbone = False
args.random_transform = True
args.image_min_side = 480
args.image_max_side = 720
args.classes = '/home/vinit/data/human_seat_data_JAN2020_cleaned/out/classes.csv'
args.annotations = '/home/vinit/data/human_seat_data_JAN2020_cleaned/out/annotations.csv'
...
# 16iSJefw-TX0rU-mnSGR8jmVCCYZh-brc
# start training
